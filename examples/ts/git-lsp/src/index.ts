...
async function main() {
  ...
  try {
    ...
    await workspace.fs.replaceInFiles([matches[0].file!], 'var obj1 = new Base();', 'var obj1 = new E();');
    ...
    const completions = await lsp.completions(matches[0].file!, { line: 12, character: 18 });
