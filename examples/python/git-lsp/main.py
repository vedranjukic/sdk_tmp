...
def main():
    ...
    try:
        ...
        workspace.git.clone('https://github.com/panaverse/learn-typescript', project_dir, 'master')
        ...
        workspace.fs.replace_in_files([matches[0].file], 'var obj1 = new Base();', 'var obj1 = new E();')
