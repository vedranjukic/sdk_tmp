import { GitStatus, ListBranchResponse, Match, Workspace as WorkspaceInstance, WorkspaceToolboxApi } from './client';
...
export class Git {
    ...
    public async clone(url: string, path?: string, branch?: string, commitId?: string, username?: string, password?: string): Promise<void> {
        const projectDir = await this.workspace.getWorkspaceRootDir()
