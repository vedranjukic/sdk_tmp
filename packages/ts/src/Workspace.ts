...
export class Workspace {
    ...
    public createLspServer(languageId: LspLanguageId, pathToProject: string): LspServer {
        return new LspServer(languageId, pathToProject, this.toolboxApi, this.instance)
    }
}