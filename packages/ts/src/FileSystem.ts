import { FileInfo, Match, ReplaceRequest, ReplaceResult, SearchFilesResponse, Workspace as WorkspaceInstance, WorkspaceToolboxApi } from './client';
...
export class FileSystem {
    ...
    public replaceInFiles(files: string[], pattern: string, newValue: string): Promise<Array<ReplaceResult>> {
    ...
    public searchFiles(path: string, pattern: string): Promise<SearchFilesResponse> {
    ...
    public setFilePermissions(path: string, permissions: FilePermissionsParams): Promise<void> {
