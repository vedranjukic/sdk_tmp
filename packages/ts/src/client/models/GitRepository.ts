...
export function GitRepositoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): GitRepository {
    ...
    return {
        ...
        'branch': json['branch'],
        'cloneTarget': json['cloneTarget'] == null ? undefined : CloneTargetFromJSON(json['cloneTarget']),
        'id': json['id'],
        'name': json['name'],
        'owner': json['owner'],
...
export function GitRepositoryToJSONTyped(value?: GitRepository | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
