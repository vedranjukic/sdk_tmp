...
export function ProjectConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectConfig {
    if (json == null) {
        return json;
    }
    return {
        ...
        'image': json['image'],
        'name': json['name'],
        'prebuilds': json['prebuilds'] == null ? undefined : ((json['prebuilds'] as Array<any>).map(PrebuildConfigFromJSON)),
...
export function ProjectConfigToJSONTyped(value?: ProjectConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'image': value['image'],
        'name': value['name'],
        'prebuilds': value['prebuilds'] == null ? undefined : ((value['prebuilds'] as Array<any>).map(PrebuildConfigToJSON)),
