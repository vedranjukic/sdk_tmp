 ...
 */
export function instanceOfCreateProjectConfigDTO(value: object): value is CreateProjectConfigDTO {
...
export function CreateProjectConfigDTOFromJSON(json: any): CreateProjectConfigDTO {
    return CreateProjectConfigDTOFromJSONTyped(json, false);
}

export function CreateProjectConfigDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateProjectConfigDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateProjectConfigDTOToJSON(json: any): CreateProjectConfigDTO {
    return CreateProjectConfigDTOToJSONTyped(json, false);
}

export function CreateProjectConfigDTOToJSONTyped(value?: CreateProjectConfigDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
