 ...
 */
export function instanceOfSetGitProviderConfig(value: object): value is SetGitProviderConfig {
...
export function SetGitProviderConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetGitProviderConfig {
    if (json == null) {
        return json;
    }
    return {
        ...
        'signingMethod': json['signingMethod'] == null ? undefined : SigningMethodFromJSON(json['signingMethod']),
        'token': json['token'],
...
export function SetGitProviderConfigToJSONTyped(value?: SetGitProviderConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
