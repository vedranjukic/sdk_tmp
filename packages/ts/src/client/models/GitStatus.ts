...
export function instanceOfGitStatus(value: object): value is GitStatus {
    if (!('currentBranch' in value) || value['currentBranch'] === undefined) return false;
    if (!('fileStatus' in value) || value['fileStatus'] === undefined) return false;
    return true;
}
...
export function GitStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): GitStatus {
    if (json == null) {
        return json;
    }
    return {
...
export function GitStatusToJSONTyped(value?: GitStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
