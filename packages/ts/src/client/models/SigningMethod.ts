...
export function SigningMethodFromJSONTyped(json: any, ignoreDiscriminator: boolean): SigningMethod {
...
export function SigningMethodToJSONTyped(value: any, ignoreDiscriminator: boolean): SigningMethod {
