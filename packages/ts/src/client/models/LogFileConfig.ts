...
export function instanceOfLogFileConfig(value: object): value is LogFileConfig {
    ...
    if (!('maxBackups' in value) || value['maxBackups'] === undefined) return false;
...
export function LogFileConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): LogFileConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function LogFileConfigToJSONTyped(value?: LogFileConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
