...
export function LspServerRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): LspServerRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function LspServerRequestToJSONTyped(value?: LspServerRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
