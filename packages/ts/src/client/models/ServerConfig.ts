...
export function instanceOfServerConfig(value: object): value is ServerConfig {
    ...
    if (!('binariesPath' in value) || value['binariesPath'] === undefined) return false;
    if (!('builderImage' in value) || value['builderImage'] === undefined) return false;
    if (!('builderRegistryServer' in value) || value['builderRegistryServer'] === undefined) return false;
    if (!('defaultProjectImage' in value) || value['defaultProjectImage'] === undefined) return false;
    if (!('defaultProjectUser' in value) || value['defaultProjectUser'] === undefined) return false;
    if (!('headscalePort' in value) || value['headscalePort'] === undefined) return false;
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('localBuilderRegistryImage' in value) || value['localBuilderRegistryImage'] === undefined) return false;
    if (!('localBuilderRegistryPort' in value) || value['localBuilderRegistryPort'] === undefined) return false;
    if (!('logFile' in value) || value['logFile'] === undefined) return false;
    if (!('providersDir' in value) || value['providersDir'] === undefined) return false;
    if (!('registryUrl' in value) || value['registryUrl'] === undefined) return false;
    if (!('serverDownloadUrl' in value) || value['serverDownloadUrl'] === undefined) return false;
    return true;
}
...
export function ServerConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServerConfig {
    ...
    return {
        ...
        'buildImageNamespace': json['buildImageNamespace'] == null ? undefined : json['buildImageNamespace'],
