 ...
 */
export function instanceOfCreatePrebuildDTO(value: object): value is CreatePrebuildDTO {
...
export function CreatePrebuildDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatePrebuildDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function CreatePrebuildDTOToJSONTyped(value?: CreatePrebuildDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
