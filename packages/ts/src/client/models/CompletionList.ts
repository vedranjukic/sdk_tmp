 ...
 */
export function instanceOfCompletionList(value: object): value is CompletionList {
    if (!('isIncomplete' in value) || value['isIncomplete'] === undefined) return false;
...
export function CompletionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompletionList {
    if (json == null) {
        return json;
    }
    return {
...
export function CompletionListToJSONTyped(value?: CompletionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
