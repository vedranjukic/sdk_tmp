...
export function LspSymbolFromJSONTyped(json: any, ignoreDiscriminator: boolean): LspSymbol {
    if (json == null) {
        return json;
    }
    return {
...
export function LspSymbolToJSONTyped(value?: LspSymbol | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
