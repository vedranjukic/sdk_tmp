 ...
 */
export function instanceOfGitRepoRequest(value: object): value is GitRepoRequest {
...
export function GitRepoRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GitRepoRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function GitRepoRequestToJSONTyped(value?: GitRepoRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
