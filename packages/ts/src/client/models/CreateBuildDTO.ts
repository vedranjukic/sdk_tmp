 ...
 */
export function instanceOfCreateBuildDTO(value: object): value is CreateBuildDTO {
...
export function CreateBuildDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateBuildDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateBuildDTOToJSONTyped(value?: CreateBuildDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
