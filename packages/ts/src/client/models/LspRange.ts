...
export function LspRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LspRange {
    if (json == null) {
        return json;
    }
    return {
...
export function LspRangeToJSONTyped(value?: LspRange | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
