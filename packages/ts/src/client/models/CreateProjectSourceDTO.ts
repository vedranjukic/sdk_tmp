 ...
 */
export function instanceOfCreateProjectSourceDTO(value: object): value is CreateProjectSourceDTO {
    if (!('repository' in value) || value['repository'] === undefined) return false;
    return true;
}

export function CreateProjectSourceDTOFromJSON(json: any): CreateProjectSourceDTO {
    return CreateProjectSourceDTOFromJSONTyped(json, false);
}

export function CreateProjectSourceDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateProjectSourceDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateProjectSourceDTOToJSON(json: any): CreateProjectSourceDTO {
    return CreateProjectSourceDTOToJSONTyped(json, false);
}

export function CreateProjectSourceDTOToJSONTyped(value?: CreateProjectSourceDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
