 ...
 */
export function instanceOfProviderTarget(value: object): value is ProviderTarget {
...
export function ProviderTargetFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProviderTarget {
    if (json == null) {
        return json;
    }
    return {
...
export function ProviderTargetToJSONTyped(value?: ProviderTarget | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
