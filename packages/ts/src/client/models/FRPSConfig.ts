...
export function FRPSConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): FRPSConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function FRPSConfigToJSONTyped(value?: FRPSConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
