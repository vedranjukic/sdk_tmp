...
export function GitCommitInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): GitCommitInfo {
    if (json == null) {
        return json;
    }
    return {
...
export function GitCommitInfoToJSONTyped(value?: GitCommitInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
