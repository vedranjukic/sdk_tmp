 ...
 */
export function instanceOfGetRepositoryContext(value: object): value is GetRepositoryContext {
...
export function GetRepositoryContextFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetRepositoryContext {
    if (json == null) {
        return json;
    }
    return {
...
export function GetRepositoryContextToJSONTyped(value?: GetRepositoryContext | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
