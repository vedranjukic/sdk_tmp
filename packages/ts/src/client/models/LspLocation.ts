...
export function LspLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): LspLocation {
    if (json == null) {
        return json;
    }
    return {
...
export function LspLocationToJSONTyped(value?: LspLocation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
