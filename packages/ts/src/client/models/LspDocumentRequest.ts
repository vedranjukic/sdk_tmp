...
export function LspDocumentRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): LspDocumentRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function LspDocumentRequestToJSONTyped(value?: LspDocumentRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
