...
export function ApikeyApiKeyTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApikeyApiKeyType {
...
export function ApikeyApiKeyTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): ApikeyApiKeyType {
