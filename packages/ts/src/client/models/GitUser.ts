...
export function GitUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): GitUser {
    if (json == null) {
        return json;
    }
    return {
...
export function GitUserToJSONTyped(value?: GitUser | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
