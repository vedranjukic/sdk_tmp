 ...
 */
export function instanceOfSetProjectState(value: object): value is SetProjectState {
...
export function SetProjectStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetProjectState {
    if (json == null) {
        return json;
    }
    return {
...
export function SetProjectStateToJSONTyped(value?: SetProjectState | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
