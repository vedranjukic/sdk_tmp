 ...
 */
export function instanceOfCreateProviderTargetDTO(value: object): value is CreateProviderTargetDTO {
...
export function CreateProviderTargetDTOFromJSON(json: any): CreateProviderTargetDTO {
    return CreateProviderTargetDTOFromJSONTyped(json, false);
}

export function CreateProviderTargetDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateProviderTargetDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateProviderTargetDTOToJSON(json: any): CreateProviderTargetDTO {
    return CreateProviderTargetDTOToJSONTyped(json, false);
}

export function CreateProviderTargetDTOToJSONTyped(value?: CreateProviderTargetDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
