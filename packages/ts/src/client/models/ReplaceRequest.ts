 ...
 */
export function instanceOfReplaceRequest(value: object): value is ReplaceRequest {
...
export function ReplaceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReplaceRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ReplaceRequestToJSONTyped(value?: ReplaceRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
