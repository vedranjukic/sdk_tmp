...
export function GitAddRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GitAddRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function GitAddRequestToJSONTyped(value?: GitAddRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
