 ...
 */
export function instanceOfGitPullRequest(value: object): value is GitPullRequest {
    if (!('branch' in value) || value['branch'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('sha' in value) || value['sha'] === undefined) return false;
    if (!('sourceRepoId' in value) || value['sourceRepoId'] === undefined) return false;
    if (!('sourceRepoName' in value) || value['sourceRepoName'] === undefined) return false;
    if (!('sourceRepoOwner' in value) || value['sourceRepoOwner'] === undefined) return false;
    if (!('sourceRepoUrl' in value) || value['sourceRepoUrl'] === undefined) return false;
    return true;
}
...
export function GitPullRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GitPullRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function GitPullRequestToJSONTyped(value?: GitPullRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
