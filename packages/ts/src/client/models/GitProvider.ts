...
export function GitProviderFromJSONTyped(json: any, ignoreDiscriminator: boolean): GitProvider {
    if (json == null) {
        return json;
    }
    return {
...
export function GitProviderToJSONTyped(value?: GitProvider | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
