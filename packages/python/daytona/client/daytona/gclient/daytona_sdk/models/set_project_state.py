...
class SetProjectState(BaseModel):
    """
    SetProjectState
    """ # noqa: E501
    git_status: Optional[GitStatus] = Field(default=None, alias="gitStatus")
    uptime: StrictInt
    __properties: ClassVar[List[str]] = ["gitStatus", "uptime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.git_status:
            _dict['gitStatus'] = self.git_status.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gitStatus": GitStatus.from_dict(obj["gitStatus"]) if obj.get("gitStatus") is not None else None,
