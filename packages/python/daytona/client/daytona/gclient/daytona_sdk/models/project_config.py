...
class ProjectConfig(BaseModel):
    ...
    user: StrictStr
    __properties: ClassVar[List[str]] = ["buildConfig", "default", "envVars", "gitProviderConfigId", "image", "name", "prebuilds", "repositoryUrl", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image": obj.get("image"),
            "name": obj.get("name"),
            "prebuilds": [PrebuildConfig.from_dict(_item) for _item in obj["prebuilds"]] if obj.get("prebuilds") is not None else None,
