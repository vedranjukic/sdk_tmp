...
class TestWorkspaceDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WorkspaceDTO:
        ...
        if include_optional:
            return WorkspaceDTO(
                id = '',
                info = daytona.gclient.daytona_sdk.models.workspace_info.WorkspaceInfo(
                    name = '', 
                    projects = [
                ...
                name = '',
                projects = [
                    daytona.gclient.daytona_sdk.models.project.Project(
                        ...
                        repository = daytona.gclient.daytona_sdk.models.git_repository.GitRepository(
                            ...
                            source = '', 
                            url = '', ), 
                        state = daytona.gclient.daytona_sdk.models.project_state.ProjectState(
                            git_status = daytona.gclient.daytona_sdk.models.git_status.GitStatus(
                                ahead = 56, 
                                behind = 56, 
                                branch_published = True, 
                                current_branch = '', 
                                file_status = [
                                    daytona.gclient.daytona_sdk.models.file_status.FileStatus(
                                        extra = '', 
                                        name = '', 
                                        staging = 'Unmodified', 
                                        worktree = 'Unmodified', )
