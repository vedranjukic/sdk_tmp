...
class TestLspSymbol(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LspSymbol:
        ...
        if include_optional:
            return LspSymbol(
                kind = 56,
                location = daytonasdk.models.lsp_location.LspLocation(
                    range = daytonasdk.models.lsp_range.LspRange(
                        end = daytonasdk.models.lsp_position.LspPosition(
                            character = 56, 
                            line = 56, ), 
                        start = daytonasdk.models.lsp_position.LspPosition(
                            character = 56, 
                            line = 56, ), ), 
                    uri = '', ),
                name = ''
