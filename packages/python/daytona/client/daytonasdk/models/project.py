...
class Project(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["buildConfig", "envVars", "gitProviderConfigId", "image", "name", "repository", "state", "target", "user", "workspaceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": ProjectState.from_dict(obj["state"]) if obj.get("state") is not None else None,
