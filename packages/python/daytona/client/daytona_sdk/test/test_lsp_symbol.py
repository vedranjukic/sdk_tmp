...
class TestLspSymbol(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LspSymbol:
        ...
        if include_optional:
            return LspSymbol(
                kind = 56,
                location = daytona_sdk.models.lsp_location.LspLocation(
                    range = daytona_sdk.models.lsp_range.LspRange(
                        end = daytona_sdk.models.lsp_position.LspPosition(
                            character = 56, 
                            line = 56, ), 
                        start = daytona_sdk.models.lsp_position.LspPosition(
                            character = 56, 
                            line = 56, ), ), 
                    uri = '', ),
                name = ''
