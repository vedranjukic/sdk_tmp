...
class WorkspaceInfo(BaseModel):
    ...
    provider_metadata: Optional[StrictStr] = Field(default=None, alias="providerMetadata")
    __properties: ClassVar[List[str]] = ["name", "projects", "providerMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "projects": [ProjectInfo.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None,
