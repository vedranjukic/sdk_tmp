...
class TestLspSymbol(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LspSymbol:
        ...
        if include_optional:
            return LspSymbol(
                kind = 56,
                location = apiclient.models.lsp_location.LspLocation(
                    range = apiclient.models.lsp_range.LspRange(
                        end = apiclient.models.lsp_position.LspPosition(
                            character = 56, 
                            line = 56, ), 
                        start = apiclient.models.lsp_position.LspPosition(
                            character = 56, 
                            line = 56, ), ), 
                    uri = '', ),
                name = ''
