...
class InstallProviderRequest(BaseModel):
    ...
    download_urls: Dict[str, StrictStr] = Field(alias="downloadUrls")
    name: StrictStr
    __properties: ClassVar[List[str]] = ["downloadUrls", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"downloadUrls": obj.get("downloadUrls"), "name": obj.get("name")}
        )
        return _obj
