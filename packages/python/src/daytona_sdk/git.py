...
from apiclient import GitStatus, ListBranchResponse, Match, Workspace as WorkspaceInstance, WorkspaceToolboxApi
...
class Git:
    ...
    def clone(self, url: str, path: Optional[str] = None, branch: Optional[str] = None, 
             commit_id: Optional[str] = None, username: Optional[str] = None, 
             password: Optional[str] = None) -> None:
        if path is None:
            path = self.workspace.get_workspace_root_dir()
