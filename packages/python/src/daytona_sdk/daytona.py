...
class Daytona:
    def __init__(self, config: Optional[DaytonaConfig] = None):
        ...
        if config is None:
            ...
            env.read_env('.env.local', override=True)  # reads .env.local and overrides values
    ...
    def remove(self, workspace: Workspace) -> None:
        ...
        """
        return self.workspace_api.remove_workspace(
    ...
    def get_current_workspace(self) -> Workspace:
        ...
        return Workspace(workspace_id, workspace_instance, self.toolbox_api, code_toolbox)